    ...
    <div className="p-[4rem]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 justify-items-center">
        <div className="flex flex-col justify-center items-center">
          <img className="w-10 sm:w-12 md:w-16" src={m1} alt="not work" />
          <p className="text-center">CUSTOMERS</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <img className="w-10 sm:w-12 md:w-16" src={m12} alt="not work" />
          <p className="text-center">Years of Excellence</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <img className="w-10 sm:w-12 md:w-16" src={m41} alt="not work" />
          <p className="text-center">R&D Engineers</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <img className="w-9 sm:w-12 md:w-16" src={m78} alt="not work" />
          <p className="text-center">Countries</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <img className="w-10 sm:w-12 md:w-16" src={m3287} alt="not work" />
